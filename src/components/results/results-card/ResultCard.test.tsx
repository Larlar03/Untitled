...
describe('testing the results display', () => {
    ...
    test('given 2 results are returned, only the first result card is displayed', () => {
        const mockTwoResults: Studio[] = [
            ...
            },
            {
                ...
                location: {
                    address:
                        'Unit 10B, Robins Business Park, Bagnall St, West Bromwich',
                    post_code: 'DY4 7BS',
                    city: 'Birmingham',
                    region: 'West Midlands',
                    country: 'England'
    ...
    test('given 3 or more results are returned, only 3 result cards of the first 3 results are displayed', () => {
        const mockFiveResults: Studio[] = [
            ...
            },
            {
                ...
                location: {
                    address:
                        'One Fitness Academy, 509 Aldrige Road, Great Barr',
                    post_code: 'B44 8NA',
                    city: 'Birmingham',
                    region: 'West Midlands',
                    country: 'England'
        ...
        const card = screen.getAllByTestId('results-card');
        const mockResultOne = screen.getByText('Siren Asylum');
        const mockResultTwo = screen.getByText('AYC Studios');
        const mockResultThree = screen.getByText('K Pole Cradely Heath');
